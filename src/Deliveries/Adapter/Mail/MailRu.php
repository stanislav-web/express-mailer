...
/**
 * MailRu class. Mail.Ru connection client
 *
 * @package Deliveries
 * @subpackage Deliveries\Adapter\Mail
 * @since PHP >=5.5
 * @version 1.0
 * @author Stanislav WEB | Lugansk <stanisov@MailRu.com>
 * @copyright Stanislav WEB
 * @filesource /Deliveries/Adapter/Mail/MailRu.php
 */
class MailRu implements MailProviderInterface {

    /**
     * Default mail host
     */
    const DEFAULT_HOST = 'smtp.mail.ru';
